...
from ..models import ContentBlock, GeneratedPage, Question, ProductData
...
class FAQTemplate(BaseTemplate):
    ...
    def render(self, content_blocks: List[ContentBlock], questions: List[Question] = None, product_data: ProductData = None, **kwargs) -> GeneratedPage:
        ...
        # Sort by category then priority (desc) to match original behavior
